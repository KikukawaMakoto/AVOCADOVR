    ...
    public class IK : MonoBehaviour {
        ...
        */
        ...
        void OnAnimatorIK(int layerIndex) {
            if (avatar) {
                if (ikActive) {
                    if (avatar.GetCurrentAnimatorStateInfo(0).IsName("Idle")) {
                    ...
                    if (leftFootObj != null && avatar.GetCurrentAnimatorStateInfo(0).IsName("Idle")) {
                    ...
                    if (rightFootObj != null && avatar.GetCurrentAnimatorStateInfo(0).IsName("Idle")) {
